...
public class CosasString {
    public void caracteres(){
        ...
        System.out.println("Mi nombre leido desde BBDD es "+ nombre+".");
        nombre = nombre.trim();
        System.out.println("Mi nombre leido sin espacios es "+ nombre+".");
        ...
        System.out.println("Mi frase reemplazo chao por hola es "+reemplazar);
